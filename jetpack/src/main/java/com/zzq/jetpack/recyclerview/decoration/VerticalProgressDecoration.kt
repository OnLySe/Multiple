package com.zzq.recyclerview.decoration
...
class VerticalProgressDecoration(private val context: Context) : RecyclerView.ItemDecoration() {
    ...
    init {
        ...
        circlePaint.color = ContextCompat.getColor(context, R.color.purple_500)
        circlePaint.style = Paint.Style.FILL
        circlePaint.strokeWidth = strokeWidth.toFloat()

        linePaint.flags = Paint.ANTI_ALIAS_FLAG
        linePaint.color = ContextCompat.getColor(context, R.color.purple_500)
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        repeat(parent.childCount) {
            ...
            if (childLayoutPosition > curPosition) {
                circlePaint.color = ContextCompat.getColor(context, R.color.teal_200)
